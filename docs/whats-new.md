...
- Editor: wikilink plugin — [[target]] renders as clickable link
- Editor: more dark themes
...
- File menu: "More" (threedot) menu dropdown
- File menu: "Reveal file location" (in Explorer or Finder)
